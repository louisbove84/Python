...
def get_pet_labels(image_dir):
    ...
    items_in_dic = len(petlabels_dic)
    ...
    for idx in range(0, len(filename_list), 1):
        ...
        #Change image name to use " " and lowercase
        ...
        if filename_list[idx] not in petlabels_dic:
            ...
            #print("Filename=", filename_list[idx], "    Label= ", petlabels_dic[filename_list[idx]])
        
        else:
            print("** Warning: Key=", filename_list[idx], 
                "already exists in results_dic with value =", 
                petlabels_dic[filename_list[idx]])
